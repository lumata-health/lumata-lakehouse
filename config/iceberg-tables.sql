...
CREATE TABLE IF NOT EXISTS sf_raw_dev.sf_user (
...
LOCATION 's3://lumata-lakehouse-raw-dev/iceberg/sf_user/'
TBLPROPERTIES (
...
CREATE TABLE IF NOT EXISTS sf_curated_dev.dim_sf_user_scd (
...
LOCATION 's3://lumata-lakehouse-raw-dev/iceberg/dim_sf_user_scd/'
TBLPROPERTIES (
    'write.format.default'='parquet',
